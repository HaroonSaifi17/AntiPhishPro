        ...
        <div className='blog-wpr'>
          ...
          <div className='flex-wpr'>
            ...
            <div className='card'>
              ...
              <h4>The Role of Artificial Intelligence in Phishing Defense</h4>
              <p>
            ...
            <div className='card'>
              ...
              <h4>Phishing Beyond Email: Exploring New Attack Vectors</h4>
              <p>
                Beyond email phishing: SMS, voice, and social media. Case
                studies of non-email phishing attacks
              </p>
            </div>
            <div className='card'>
              <img src={card4} alt='' />
